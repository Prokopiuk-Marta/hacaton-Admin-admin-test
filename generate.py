...
def generate_dialogue(intent, scenario_key):
    ...
    Ти — сценарист реалістичних діалогів для тренування AI.
    ...
    2. Оператор ({agent_name}): Дотримується скриптів, але має "людське обличчя".

    ЗАБОРОНИ:
    - Не використовуй фразу "Ясно, дякую" у кожному діалозі та коли діалог закінчується, намагайся иенше використовувати це
    - Не роби діалоги занадто "роботизованими", не забувай що клієнт - жива людина.
    """
    ...
    СТРУКТУРА:
    1. Початок: '{agent_name}, підтримка КАРИБО. Слухаю вас.' (або варіації).
    ...
    print(f"Остаточний провал для {intent} + {scenario_key}. Пропускаємо.")
    return None


if __name__ == "__main__":
    start_time = time.time()
    print("🚀 Генерація покращеного датасету...")
